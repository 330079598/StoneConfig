...
function print_logo()
{
    ...
    echo ''
    echo 'Just enjoy it!'
    echo 'p.s. Follow me at https://github.com/330079598/StoneConfig.'
    echo ''
    printf "${normal}"
}
...
# 在ubuntu系上安装vim
function install_vim_on_ubuntu_like()
{
...
# 在centos上安装vim
function install_vim_on_centos()
{
...
# 在fedora上安装vim
function install_vim_on_fedora()
{
...
# 在opensuse上安装vim
function install_vim_on_opensuse()
{
...
function install_vim_on_linux()
{
    ...
    if [ ${distro} == "Ubuntu" ]; then
        ...
        install_vim_on_fedora
    elif [ ${distro} == "openSUSE" ]; then
        install_vim_on_opensuse
